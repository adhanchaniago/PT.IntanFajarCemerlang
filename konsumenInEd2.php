...
<form action="konsumenInPros.php" method="post" enctype="multipart/form-data">
	<table>
		...
		<tr>
			<td>No. KTP</td>
			<td><input type="text" name="vnoktp" value="<?php echo $data['no_ktp']; ?>" readonly></td>
		</tr>
		<tr>
			<td>Nama Lengkap</td>
			<td><input type="text" name="vnama" value="<?php echo $data['nama']; ?>"></td>
		</tr>
		<tr>
			<td>Tempat Lahir</td>
			<td><input type="text" name="vtmptlhr" value="<?php echo $data['tempat_lahir']; ?>"></td>
		</tr>
		<tr>
			<td>Tanggal Lahir</td>
			<td>
		...
		<tr>
			...
			<td>
				<select name="vjekel">
					<option value=""><?php echo $data['jekel']; ?></option>
		...
		<tr>
			<td>Pekerjaan</td>
			<td><input type="text" name="vpekerjaan" value="<?php echo $data['pekerjaan']; ?>"></td>
		</tr>
		<tr>
			<td>Agama</td>
			<td>
		...
		<tr>
			...
			<td>
				<select name="vstatpern">
					<option value=""><?php echo $data['stat_nikah']; ?></option>
		...
		<tr>
			<td>Alamat</td>
			<td><textarea name="valmt" cols="25" rows="3"><?php echo $data['alamat']; ?></textarea></td>
		</tr>
		<tr>
			<td>No. HP / Telepon</td>
			<td><input type="text" name="vtelp" value="<?php echo $data['telp']; ?>"></td>
		</tr>
		<tr>
			<td>Foto</td>
